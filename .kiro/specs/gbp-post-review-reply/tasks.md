...
- [x] 1.1 GBP 連携用の DB スキーマを確立する
  - migration 0013（改番前は 0006）として gbp_locations（store 一意・account/location リソース名・placeId・投稿可否）と gbp_sessions（owner 一意・flow/stage enum・payload・draft・期限）を追加する
