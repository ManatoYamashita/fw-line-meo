...
| 契約 | 出典（テストファイル） |
|---|---|
| store-detail は書込要素を描画せず、入力は検索欄と選択肢に限る（2026-09-13 に [#265](https://github.com/ManatoYamashita/fw-line-meo/issues/265) で改定。判断は §7.18） | `ts/apps/store-detail/test/store-page.test.tsx` |
