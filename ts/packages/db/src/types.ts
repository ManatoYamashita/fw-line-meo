...
// --- gbp-post-review-reply（0001 oauth_tokens 実運用化 + 0013 新設 2 表）---

// 0001 冒頭の CREATE TYPE oauth_provider と 1:1。
export type OauthProvider = 'google';

// 0013 の CREATE TYPE gbp_flow / gbp_stage と 1:1。
...
// GBP 会話セッション（0013・owner 1:1・期限付き・TS 書込）。
